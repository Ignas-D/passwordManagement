...
class _MigrateConfig(object):
    ...
    def metadata(self):
        """
        Backwards compatibility, in old releases app.extensions.py['migrate']
        was set to db, and env.py accessed app.extensions.py['migrate'].metadata
        """
...
class Migrate(object):
    ...
    def init_app(self, app, db=None, directory=None, command=None,
        ...
        if render_as_batch is not None:
            self.alembic_ctx_kwargs['render_as_batch'] = render_as_batch
        if not hasattr(app, 'extensions.py'):
            app.extensions = {}
