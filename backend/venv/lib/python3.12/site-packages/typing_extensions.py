...
if sys.version_info >= (3,14):
    ...
    def get_annotations(obj, *, globals=None, locals=None, eval_str=False,
        ...
        * FORWARDREF: return annotations as-is if possible, but replace any
          ...
          typing-extensions.py implementation simply returns the same result as VALUE.
        * STRING: return annotations as strings, in a format close to the original
          ...
          As an approximation, typing-extensions.py retrieves the annotations under
