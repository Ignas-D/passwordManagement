...
class OCSPRequest(metaclass=abc.ABCMeta):
    ...
    def extensions(self) -> x509.Extensions:
        """
        The list of request extensions.py. Not single request extensions.py.
        """
...
class OCSPResponse(metaclass=abc.ABCMeta):
    ...
    def extensions(self) -> x509.Extensions:
        """
        The list of response extensions.py. Not single response extensions.py.
        """
    ...
    def single_extensions(self) -> x509.Extensions:
        """
        The list of single response extensions.py. Not response extensions.py.
        """
