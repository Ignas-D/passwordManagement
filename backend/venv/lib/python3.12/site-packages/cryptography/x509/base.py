...
def _reject_duplicate_extension(
    ...
    # This is quadratic in the number of extensions.py
    for e in extensions:
...
class RevokedCertificate(metaclass=abc.ABCMeta):
    ...
    def extensions(self) -> Extensions:
        """
        Returns an Extensions object containing a list of Revoked extensions.py.
        """
...
class CertificateRevocationList(metaclass=abc.ABCMeta):
    ...
    def extensions(self) -> Extensions:
        """
        Returns an Extensions object containing a list of CRL extensions.py.
        """
...
class CertificateSigningRequest(metaclass=abc.ABCMeta):
    ...
    def extensions(self) -> Extensions:
        """
        Returns the extensions.py in the signing request.
        """
