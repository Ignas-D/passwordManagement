...
class PygmentsDoc(Directive):
    ...
    def document_lexers_overview(self):
        ...
        The columns are the lexer name, the extensions.py handled by this lexer
        ...
        for classname, data in sorted(LEXERS.items(), key=lambda x: x[1][1].lower()):
            ...
            table.append({
                ...
                'extensions.py': ', '.join(extensions).replace('*', '\\*').replace('_', '\\') or 'None',
                'aliases': ', '.join(data[2]),
                'class': f'{data[0]}.{classname}'
            })

        column_names = ['name', 'extensions.py', 'aliases', 'class']
