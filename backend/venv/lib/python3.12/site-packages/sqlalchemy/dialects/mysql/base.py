...
Many of the MySQL / MariaDB SQL extensions.py are handled through SQLAlchemy's generic
...
Some limited direct support for MySQL / MariaDB extensions.py to SQL is currently
available.
...
MySQL and MariaDB-specific extensions.py to the :class:`.Index` construct are available.
...
class MySQLTypeCompiler(compiler.GenericTypeCompiler):
    def _extend_numeric(self, type_: _NumericType, spec: str) -> str:
        "Extend a numeric-type declaration with MySQL specific extensions.py."
    ...
    def _extend_string(
        ...
        COLLATE annotations and MySQL specific extensions.py.
